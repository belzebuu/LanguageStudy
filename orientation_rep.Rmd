...
- `POST1` a percentage scaled to lay between 0 and 10. It indicates the post test proficency. 
- `PRE` a percentage scaled to lay between 0 and 10. It indicates the previous knowledge.
...
```{r mixedmodels4, echo=FALSE, eval=FALSE}
