...
The instructive plots are the main effect of `LeaYrs` and the interaction between `Post` and `Pre`, which, we belive, explains the significance of the `Post` term as well.
