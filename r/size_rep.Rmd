...
options(formatR.arrow=TRUE, width=140, digits=3,show.signif.stars = TRUE)
library(ggplot2)
library(party)
library(dplyr)
library(lme4)
...
Or in a pretty table form:

```{r prettytable, echo=FALSE, results='asis'}
require(xtable)
...
and the effects with the ttest:
